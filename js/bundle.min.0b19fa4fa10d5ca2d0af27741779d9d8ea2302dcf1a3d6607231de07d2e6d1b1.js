...
function sleep(ms,fn){return setTimeout(function(){fn()},ms)}
function showPrivacy(){if(localStorage.getItem("cookieSeen")!="shown"){sleep(5000,showPrivacyPopup)}}
showPrivacy()
function showPrivacyPopup(){var x=document.getElementById("snackbar");x.className="show";localStorage.setItem("cookieSeen","shown")}
function closePrivacy(){var x=document.getElementById("snackbar");x.className="hide";}
